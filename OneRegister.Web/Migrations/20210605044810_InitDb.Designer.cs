...
namespace OneRegister.Web.Migrations
{
    ...
    [Migration("20210605044810_InitDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneRegister.Data.Entities.MerchantRegistration.MerchantExtraInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("BPCodeAP")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");

                    b.Property<string>("BPCodeAR")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.Property<string>("MonthlyRental")
                        .HasMaxLength(256)
                    ...
                    b.Property<string>("RiskComments")
                        .HasMaxLength(512)
                        .HasColumnType("nvarchar(512)");
                    ...
                    b.ToTable("MerchantExtraInfo", "Merchant");
                });
            ...
            modelBuilder.Entity("OneRegister.Data.Entities.Notification.NotificationJob", b =>
                {
                    ...
                    b.ToTable("NotificationJob", "Base");
                });
            ...
            modelBuilder.Entity("OneRegister.Data.Entities.Notification.NotificationTask", b =>
                {
                    ...
                    b.ToTable("NotificationTask", "Base");
                });
            ...
            modelBuilder.Entity("OneRegister.Data.Entities.MerchantRegistration.MerchantExtraInfo", b =>
                {
                    b.HasOne("OneRegister.Data.Entities.MerchantRegistration.Merchant", "Merchant")
                        .WithOne("MerchantExtraInfo")
                        .HasForeignKey("OneRegister.Data.Entities.MerchantRegistration.MerchantExtraInfo", "MerchantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OneRegister.Data.Entities.MerchantRegistration.Merchant", b =>
                {
                    b.Navigation("MerchantExtraInfo");
